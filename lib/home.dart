import 'package:bmi_project/logic.dart';
                    ...
                    onTap: () {
                      setState(() {
                        if (widget._co_male == Colors.white) {
                          widget._co_male = Colors.deepOrange;
                          widget._co_fe = Colors.white;
                          widget._a = "male";
                        } else if (widget._co_male == Colors.deepOrange) {
                              ...
                              onTap: () {
                                setState(() {
                                  if (widget._co_fe == Colors.white) {
                                    widget._co_fe = Colors.deepOrange;
                                    widget._co_male = Colors.white;
                                    widget._a = "female";
                                  } else if (widget._co_fe ==
                                      Colors.deepOrange) {
                                    widget._co_fe = Colors.white;
                                    widget._a = "";
                                  }
